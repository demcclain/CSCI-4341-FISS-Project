This fork contains added json files and edited code to run them, otherwise it is identical to the repo it is forked from:

- **`femnist_testing_iid.json`** – IID FEMNIST evaluation  
